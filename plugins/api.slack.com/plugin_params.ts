```typescript
// Generated by OpenAPI Generatorexport interface SearchRequest {
  query: string;
}
...
export interface AiAlphaSearchMessagesRequest {
  searchRequest: SearchRequest;
}

export interface AiAlphaSearchMessagesResponse {
  ok: boolean;
  results?: Result[];
}
